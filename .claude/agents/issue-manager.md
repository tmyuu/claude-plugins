...
### プロジェクト作成の判断基準
1. **SessionStart で注入されたプロジェクト一覧**を確認し、既存プロジェクトのテーマを把握
2. Issue のテーマが既存プロジェクトに合う → **既存を使う**（新規作成しない）
3. Issue のテーマが既存プロジェクトから**明らかに逸脱**している → 新規作成OK
4. リポジトリにプロジェクトがない → 新規作成OK
5. 判断に迷う場合 → **ユーザーに確認**
